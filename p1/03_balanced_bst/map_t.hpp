...
class map_t
{
	...
	//    vector<K>* keys;
	//    vector<V>* values;
	pair<K, V> Min(Node<K,V>* p);
	bool rmv(Node<K, V>* &r, K key);
	bool insrt(Node<K, V>* &p, K key, V val);
	void InOrder(std::function<void(pair<K,V>)> f, Node<K,V>* r);
	void PreOrder(std::function<void(pair<K,V>)> f, Node<K,V>* r);
	public:
	/**
	...
	map_t();
	int Hgt(Node<K, V>* t);
	Node<K, V>* L_Rotate(Node<K, V>* &t);
	Node<K, V>* R_Rotate(Node<K, V>* &t);
	Node<K, V>* LR_Rotate(Node<K, V>* &t);
	Node<K, V>* RL_Rotate(Node<K, V>* &t);
	int max(int a, int b);
	/**
	...
	void in_order(std::function<void(pair<K,V>)> f);
	void pre_order(std::function<void(pair<K,V>)> f);
	void level_order();
	/**
